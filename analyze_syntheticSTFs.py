...
for index, row in eqdata.iterrows():
    ...
    for Hz in HZ_Bands:##### Loop through values fitting
        ...
        #### Save Data
        dataout_list.append({'eq_id':row.eq_id,'MinHZ':Hz[0],'MaxHz':Hz[1],'Fc_2_Mo':est_fc_MoFixed,'SIG_2_Mo':sigma_fc_est_Mofix,'Fc_n_Mo':est_fc_freeslope,'n_Mo':est_fs_freeslope,'SIG_n_Mo':sigma_fc_est_freeslope})
